...
import Card from './CardRecPapers';
import './RecommendedPapers.css'
import AOS from 'aos';
...
const RecommendedPapers = () => {
  ...
  return (
    <div className='rec-container' data-aos="fade-up">
      <div className='rec-heading' data-aos="fade-up">
        Recommended Papers
      </div>
      <div data-aos="fade-up">
      <p className='rec-content'>Promo boxes are hyperlinked containers with a title, description, image, and link.
      ...
      <div className='rec-card-container' data-aos="fade-up">
        {displayedCards.map(card => (
          <div className='rec-card' key={card.id} data-aos="fade-up">
            <img className='rec-card-img' src={card.img} alt="dsdg" data-aos="fade-up" />
            <h2 className='rec-card-heading' data-aos="fade-up">
              {/* <Link to={`/blogs/${card.id}`}>{card.title}</Link>
               */}
              {card.title}
            </h2>
            <p className='rec-card-content' data-aos="fade-up">{card.content}</p>
          </div>
        ))}
      </div>
      <div data-aos="fade-up">
        <button className='rec-button' onClick={handleToggle}>
